...
void MyAccuracyLayer<Dtype>::SetUp(
  const vector<Blob<Dtype>*>& bottom, vector<Blob<Dtype>*>* top) {
  CHECK_EQ(bottom.size(), 2) << "MyAccuracy Layer takes two blobs as input.";
  CHECK_EQ(top->size(), 1) << "MyAccuracy Layer takes 1 output.";
...
template <typename Dtype>
Dtype MyAccuracyLayer<Dtype>::Forward_cpu(const vector<Blob<Dtype>*>& bottom,
